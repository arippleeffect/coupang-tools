...
쿠팡 상품 지표를 분석하고 로켓그로스 반출 데이터를 Excel로 내보낼 수 있는 크롬 익스텐션입니다.
...
1. 쿠팡윙(wing.coupang.com) 반출 관리 페이지 접속
2. 페이지에서 우클릭
3. "로켓그로스 반출 액셀 다운로드" 선택
...
- API 키는 환경 변수로 관리
- Activation Token은 로컬 스토리지에 암호화 없이 저장 (크롬 익스텐션 특성상 완벽한 보안 불가)
